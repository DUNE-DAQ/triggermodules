...
namespace dunedaq {
  namespace toy_generator {
    ...
    void TriggerPrimitiveSupernova::init(const nlohmann::json& init_data) {
    ...
    void TriggerPrimitiveSupernova::do_configure(const nlohmann::json& /*args*/) {
      TLOG(TLVL_ENTER_EXIT_METHODS) << get_name() << ": Entering do_configure() method";
      TLOG(TLVL_ENTER_EXIT_METHODS) << get_name() << ": Exiting do_configure() method";
    }

    void TriggerPrimitiveSupernova::do_start(const nlohmann::json& /*args*/) {
    ...
    void TriggerPrimitiveSupernova::do_stop(const nlohmann::json& /*args*/) {
    ...
    void TriggerPrimitiveSupernova::do_unconfigure(const nlohmann::json& /*args*/) {
    ...
    std::vector<TriggerPrimitive> TriggerPrimitiveSupernova::GetSupernovaEvt() {
      ...
      for (int i=0; i<nhit; ++i) {
        ...
        std::cout << "\033[30mtp.time_start : " << tp.time_start << "\033[0m  ";
        ...
        std::cout << "\033[30mtp.channel : " << tp.channel << "\033[0m\n";
        tp.time_over_threshold = pd_clock(tot_time).count();
