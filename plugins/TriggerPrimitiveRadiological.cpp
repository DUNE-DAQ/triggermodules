...
namespace dunedaq {
  namespace toy_generator {
    ...
    void TriggerPrimitiveRadiological::init(const nlohmann::json& init_data) {
    ...
    void TriggerPrimitiveRadiological::do_configure(const nlohmann::json& /*args*/) {
      TLOG(TLVL_ENTER_EXIT_METHODS) << get_name() << ": Entering do_configure() method";
      TLOG(TLVL_ENTER_EXIT_METHODS) << get_name() << ": Exiting do_configure() method";
    }

    void TriggerPrimitiveRadiological::do_start(const nlohmann::json& /*args*/) {
    ...
    void TriggerPrimitiveRadiological::do_stop(const nlohmann::json& /*args*/) {
    ...
    void TriggerPrimitiveRadiological::do_unconfigure(const nlohmann::json& /*args*/) {
