...
///////////	Conf
[
	cmd.init([queues.TPsQueue,queues.TPsQueue2,queues.TAsQueue,queues.TCsQueue,queues.TDsQueue],
		[modules.TPsGenerator, modules.TPsGenerator2, modules.TAsGenerator, modules.TAsGenerator2, modules.TCsGenerator, modules.TDsGenerator])
		{ waitms: 1000},
	cmd.conf([
